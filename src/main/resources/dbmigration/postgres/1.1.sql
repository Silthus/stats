...
alter table sstats_player_sessions alter column reason type varchar(13) using reason::varchar(13);
...
alter table sstats_player_sessions add column world_id uuid;
